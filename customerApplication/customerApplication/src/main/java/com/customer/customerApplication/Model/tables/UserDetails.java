...
import com.customer.customerApplication.Model.Indexes;
...
public class UserDetails extends TableImpl<UserDetailsRecord> {
    ...
    private static final long serialVersionUID = -141762422;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.USER_DETAILS_PKEY);
    }
    ...
    public List<ForeignKey<UserDetailsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<UserDetailsRecord, ?>>asList(Keys.USER_DETAILS__CUS_ID_FK, Keys.USER_DETAILS__ORD_ID_FK);
    }

    public Customers customers() {
        return new Customers(this, Keys.USER_DETAILS__CUS_ID_FK);
    }

    public Orders orders() {
        return new Orders(this, Keys.USER_DETAILS__ORD_ID_FK);
    }
