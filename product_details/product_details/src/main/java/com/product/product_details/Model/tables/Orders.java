...
public class Orders extends TableImpl<OrdersRecord> {
    ...
    private static final long serialVersionUID = 494427918;
     ...
     */
    public final TableField<OrdersRecord, Integer> ORDER_ID = createField(DSL.name("order_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('orders_order_id_seq'::regclass)", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>public.orders.order_status</code>.
     */
    public final TableField<OrdersRecord, String> ORDER_STATUS = createField(DSL.name("order_status"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>public.orders.products</code>.
     */
    public final TableField<OrdersRecord, String> PRODUCTS = createField(DSL.name("products"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");
